...
const About = () => {
  return (
    ...
    <div className="overlay flex flex-col items-center justify-center text-white px-5">
      ...
      <div className="flex flex-col items-center p-8 rounded-md w-60 sm:px-12 dark:text-coolGray-100">
        <div className="text-center">
          <h2 className="text-5xl font-semibold py-5">Himalaya</h2>
          <p className="text-2xl dark:text-coolGray-400">July 29</p>
          </div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-32 h-32 p-6 dark:text-yellow-400 fill-current">
            ...
            <rect width="48" height="32" x="16" y="240"></rect><rect width="32" height="45.255" x="400" y="393.373" transform="rotate(-45 416 416)"></rect>
            ...
            <p className="dark:text-coolGray-400 text-2xl">Partly cloudy</p>
            </div>
            </div>
            </div>
            </section>
